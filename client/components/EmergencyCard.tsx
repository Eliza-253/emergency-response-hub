...
const colorClasses = {
  ...
  green:
    "from-green-50 to-green-50/50 border-green-200/60 hover:from-green-100 hover:to-green-50 hover:border-green-300",
  orange:
    "from-orange-50 to-orange-50/50 border-orange-200/60 hover:from-orange-100 hover:to-orange-50 hover:border-orange-300",
};
...
export default function EmergencyCard({
  ...
  return (
    ...
    >
      {/* Background accent */}
      <div
        className="absolute -right-8 -top-8 w-24 h-24 rounded-full opacity-0 group-hover:opacity-10 transition-opacity duration-300"
        style={{
          background:
            color === "red"
              ? "rgb(220, 38, 38)"
      ...
      <div
        className={cn(
          "text-4xl mb-4 transition-transform group-hover:scale-125 group-hover:rotate-12 w-fit rounded-lg p-3",
          iconBgClasses[color],
        )}
      >
